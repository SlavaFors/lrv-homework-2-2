...
@section('title-block')Редактирование студента @endsection

@section('content')

    <div class="d-flex justify-content-between">
        <h1>Отредактировать данные студента</h1>
    </div>
    ...
    <form action=" {{ route('students.update', $student->id) }} " method="POST">
        ...
        <button type="submit" class="btn btn-success">Отредактировать данные</button>
    </form>
@endsection

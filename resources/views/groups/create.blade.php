...
@section('content')
    ...
    <form action=" {{ route('groups.store') }} " method="post">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="title" placeholder="Название группы" id="title" class="form-control" value="Группа FS-54">
        </div>

        <div class="form-group mb-2">
            <label for="start_from">Дата начала обучения</label>
            <input type="date" name="start_from" placeholder="Дата начала обучения" id="start_from" class="form-control" value="2022-11-10">
        </div>
